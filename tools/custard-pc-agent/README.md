...
2. Double click `custard_pc_agent.bat`.
...
- `custard_pc_agent.bat`: only user-facing launcher bat
...
- If browser does not open:
  ...
  4. Double click `custard_pc_agent.bat` again (it auto-cleans old process).
