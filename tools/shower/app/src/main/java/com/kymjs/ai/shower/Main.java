...
import com.kymjs.ai.shower.shell.FakeContext;
import com.kymjs.ai.shower.shell.Workarounds;
import com.kymjs.ai.shower.wrappers.ServiceManager;
import com.kymjs.ai.shower.wrappers.WindowManager;
...
public class Main {
    ...
    private static final String ACTION_SHOWER_BINDER_READY = "com.kymjs.ai.custard.action.SHOWER_BINDER_READY";
    ...
    private void launchPackageOnVirtualDisplay(String packageName, int displayId) {
        ...
        try {
            ...
            com.kymjs.ai.shower.wrappers.ActivityManager am = ServiceManager.getActivityManager();
