package com.ai.assistance.custard.util.stream.plugins

import androidx.test.ext.junit.runners.AndroidJUnit4
import com.ai.assistance.custard.util.stream.asCharStream
...
class StreamJsonPluginTest {
    ...
    private suspend fun collectGroups(
        stream: com.ai.assistance.custard.util.stream.Stream<Char>,
        plugin: StreamPlugin
    ): List<GroupInfo> {
