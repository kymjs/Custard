...
Java_com_kymjs_ai_custard_util_streamnative_NativeMarkdownSplitter_nativeCreateBlockSession(
        JNIEnv* /*env*/,
        jobject /*thiz*/
) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_kymjs_ai_custard_util_streamnative_NativeMarkdownSplitter_nativeCreateInlineSession(
        JNIEnv* /*env*/,
        jobject /*thiz*/
) {
...
Java_com_kymjs_ai_custard_util_streamnative_NativeMarkdownSplitter_nativeDestroySession(
        JNIEnv* /*env*/,
        jobject /*thiz*/,
        jlong handle
) {
...
Java_com_kymjs_ai_custard_util_streamnative_NativeMarkdownSplitter_nativePush(
        JNIEnv* env,
        jobject /*thiz*/,
        jlong handle,
        jstring chunk
