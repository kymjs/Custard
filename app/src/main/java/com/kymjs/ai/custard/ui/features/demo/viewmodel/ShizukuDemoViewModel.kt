package com.kymjs.ai.custard.ui.features.demo.viewmodel
...
import com.kymjs.ai.custard.core.tools.system.RootAuthorizer
import com.kymjs.ai.custard.R
import com.kymjs.ai.custard.ui.features.demo.state.DemoStateManager
...
class ShizukuDemoViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val uiState: StateFlow<com.kymjs.ai.custard.ui.features.demo.state.DemoScreenState> =
