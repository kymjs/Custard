package com.kymjs.ai.custard.ui.features.token
...
import com.kymjs.ai.custard.ui.features.token.components.UrlConfigDialog
import com.kymjs.ai.custard.ui.features.token.model.NavDestination
import com.kymjs.ai.custard.ui.features.token.model.getIconForIndex
import com.kymjs.ai.custard.ui.features.token.preferences.UrlConfigManager
import com.kymjs.ai.custard.ui.features.token.webview.WebViewConfig
...
fun TokenConfigWebViewScreen(onNavigateBack: () -> Unit) {
    ...
    // 获取URL配置
    val urlConfig by urlConfigManager.urlConfigFlow.collectAsState(initial = com.kymjs.ai.custard.ui.features.token.model.UrlConfig())
