...
import com.kymjs.ai.custard.api.chat.llmprovider.RateLimitedAIService
import com.kymjs.ai.custard.api.chat.llmprovider.RateLimiterRegistry
import com.kymjs.ai.custard.api.chat.llmprovider.RequestConcurrencyRegistry
...
class MultiServiceManager(private val context: Context) {
    ...
    ): List<com.kymjs.ai.custard.data.model.ModelParameter<*>> {
        ensureInitialized()
        val configMapping = functionalConfigManager.getConfigMappingForFunction(functionType)
