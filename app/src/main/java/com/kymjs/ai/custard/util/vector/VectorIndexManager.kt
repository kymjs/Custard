package com.kymjs.ai.custard.util.vector
    ...
    fun initIndex() {
        index = if (indexFile != null && indexFile.exists()) {
            try {
                ...
                com.kymjs.ai.custard.util.AppLogger.e("VectorIndexManager", "Failed to load index, creating new one.", e)
    ...
    fun save() {
        if (indexFile != null && index != null) {
            try {
                ...
                com.kymjs.ai.custard.util.AppLogger.e("VectorIndexManager", "Failed to save index to ${indexFile.absolutePath}", e)
            }
        }
    }
