...
import com.kymjs.ai.custard.core.tools.defaultTool.standard.StandardFileSystemTools
...
open class DebuggerFileSystemTools(context: Context) : StandardFileSystemTools(context) {
    ...
    companion object {
        ...
        private const val CUSTARD_PACKAGE = "com.kymjs.ai.custard"
    }
    
    /**
     * 判断路径是否为Custard应用的内部存储路径
     * 仅针对 /data/data/com.kymjs.ai.custard 开头的路径返回true
     */
