...
import com.kymjs.ai.custard.data.model.CustomParameterData
...
import com.kymjs.ai.custard.data.model.ApiKeyInfo
...
class ModelConfigManager(private val context: Context) {
    ...
    suspend fun updateModelConfig(
            ...
            apiEndpoint: String,
            modelName: String,
            apiProviderType: com.kymjs.ai.custard.data.model.ApiProviderType
    ): ModelConfigData {
        return updateConfigInternal(configId) {
            it.copy(
                    apiKey = apiKey,
...
private fun ModelParameter<*>.toCustomParameterData(): com.kymjs.ai.custard.data.model.CustomParameterData {
