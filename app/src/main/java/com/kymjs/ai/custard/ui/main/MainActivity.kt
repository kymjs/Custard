...
import com.kymjs.ai.custard.data.migration.ChatHistoryMigrationManager
import com.kymjs.ai.custard.data.preferences.AgreementPreferences
...
import com.kymjs.ai.custard.data.updates.UpdateManager
import com.kymjs.ai.custard.data.updates.UpdateStatus
import com.kymjs.ai.custard.ui.common.NavItem
import com.kymjs.ai.custard.ui.features.agreement.screens.AgreementScreen
import com.kymjs.ai.custard.ui.features.migration.screens.MigrationScreen
import com.kymjs.ai.custard.ui.features.permission.screens.PermissionGuideScreen
import com.kymjs.ai.custard.ui.features.startup.screens.PluginLoadingScreenWithState
import com.kymjs.ai.custard.ui.features.startup.screens.PluginLoadingState
...
import com.kymjs.ai.custard.util.AnrMonitor
...
class MainActivity : ComponentActivity() {
    ...
    override fun onNewIntent(intent: Intent?) {
        ...
        val isGitHubOAuthCallback = intent?.data?.let { uri ->
            uri.scheme == "custard" && uri.host == "github-oauth-callback"
        } == true
        handleIntent(intent)
    ...
    private fun handleIntent(intent: Intent?) {
        val uri = intent?.data
        if (uri != null && uri.scheme == "custard" && uri.host == "github-oauth-callback") {
    ...
    private fun cleanTemporaryFiles() {
        lifecycleScope.launch {
            try {
                val tempDir = java.io.File(CustardPaths.cleanOnExitPathSdcard())
