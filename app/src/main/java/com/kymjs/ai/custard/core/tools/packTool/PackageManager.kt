...
import com.kymjs.ai.custard.core.tools.PackageToolExecutor
import com.kymjs.ai.custard.core.tools.PackageTool
import com.kymjs.ai.custard.core.tools.ToolPackage
import com.kymjs.ai.custard.core.tools.ToolPackageState
import com.kymjs.ai.custard.core.tools.agent.ShowerController
import com.kymjs.ai.custard.core.tools.condition.ConditionEvaluator
import com.kymjs.ai.custard.core.tools.javascript.JsEngine
import com.kymjs.ai.custard.core.tools.mcp.MCPManager
import com.kymjs.ai.custard.core.tools.mcp.MCPPackage
import com.kymjs.ai.custard.core.tools.mcp.MCPServerConfig
import com.kymjs.ai.custard.core.tools.mcp.MCPToolExecutor
import com.kymjs.ai.custard.core.tools.skill.SkillManager
...
import com.kymjs.ai.custard.data.model.PackageToolPromptCategory
...
private constructor(private val context: Context, private val aiToolHandler: AIToolHandler) {
    companion object {
        ...
        private const val PACKAGE_PREFS = "com.kymjs.ai.custard.core.tools.PackageManager"
    ...
    fun getToolPkgToolboxUiModules(
        ...
        ensureInitialized()
        val localizationContext = resolveContext ?: context
        fun resolveLocalized(text: com.kymjs.ai.custard.core.tools.LocalizedText): String {
