package com.kymjs.ai.custard.api.chat.enhance

import android.content.Context
import com.kymjs.ai.custard.util.AppLogger
import com.kymjs.ai.custard.core.config.SystemPromptConfig
...
import com.kymjs.ai.custard.data.preferences.WaifuPreferences
...
import com.kymjs.ai.custard.util.streamnative.NativeXmlSplitter
...
import com.kymjs.ai.custard.core.tools.ComputerDesktopActionResultData
    ...
    private suspend fun buildWaifuRulesText(): String {
        ...
        if (waifuEnableEmoticons) {
            ...
            val availableCategories = try {
                ...
                com.kymjs.ai.custard.util.AppLogger.e("ConversationService", "获取表情分组失败", e)
                emptyList()
            }
...
${FunctionalPrompts.translationUserPrompt(targetLanguage, text)}
    ...
    suspend fun analyzeImageWithIntent(
        ...
        return try {
            ...
            // 添加图片到池子并获取ID
            val imageId = com.kymjs.ai.custard.util.ImagePoolManager.addImage(imagePath)
            if (imageId == "error") {
            ...
            // 清理图片缓存
            com.kymjs.ai.custard.util.ImagePoolManager.removeImage(imageId)
    ...
    suspend fun analyzeAudioWithIntent(
        ...
        return try {
            ...
            val mediaId = com.kymjs.ai.custard.util.MediaPoolManager.addMedia(audioPath, mimeType)
            if (mediaId == "error") {
            ...
            com.kymjs.ai.custard.util.MediaPoolManager.removeMedia(mediaId)
            result.toString()
        } catch (e: Exception) {
    ...
    suspend fun analyzeVideoWithIntent(
        ...
        return try {
            ...
            val mediaId = com.kymjs.ai.custard.util.MediaPoolManager.addMedia(videoPath, mimeType)
            if (mediaId == "error") {
