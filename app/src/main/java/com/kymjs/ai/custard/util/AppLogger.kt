...
/**
 * App-wide logger with an API closely mirroring [com.kymjs.ai.custard.util.AppLogger].
 *
...
object AppLogger {
    ...
    // Mirror com.kymjs.ai.custard.util.AppLogger priority constants
    ...
    // --- Public API mirroring com.kymjs.ai.custard.util.AppLogger ---
