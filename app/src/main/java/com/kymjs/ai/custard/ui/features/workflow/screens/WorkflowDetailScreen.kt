package com.kymjs.ai.custard.ui.features.workflow.screens
...
import com.kymjs.ai.custard.ui.features.workflow.viewmodel.WorkflowViewModel
import com.kymjs.ai.custard.ui.features.workflow.components.GridWorkflowCanvas
import com.kymjs.ai.custard.ui.features.workflow.components.ConnectionMenuDialog
import com.kymjs.ai.custard.ui.features.workflow.components.NodeActionMenuDialog
import com.kymjs.ai.custard.ui.features.workflow.components.ScheduleConfigDialog
...
fun NodeDialog(
    ...
    val initialActionConfigPairs = if (node is ExecuteNode) {
        node.actionConfig.map { (key, paramValue) ->
            when (paramValue) {
                is com.kymjs.ai.custard.data.model.ParameterValue.StaticValue -> 
                    ParameterConfig(key, false, paramValue.value)
                is com.kymjs.ai.custard.data.model.ParameterValue.NodeReference -> 
