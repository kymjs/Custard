...
import com.kymjs.ai.showerclient.ShowerServerManager as CoreShowerServerManager
 ...
 *   CLASSPATH=/data/user/0/<pkg>/files/shower-server.jar app_process / com.kymjs.ai.shower.Main
 */
