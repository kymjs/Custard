package com.kymjs.ai.custard.core.tools
...
data class WorkflowDetailResultData(
    ...
    val name: String,
    val description: String,
    val nodes: List<com.kymjs.ai.custard.data.model.WorkflowNode>,
    val connections: List<com.kymjs.ai.custard.data.model.WorkflowNodeConnection>,
    val enabled: Boolean,
    val createdAt: Long,
    val updatedAt: Long,
    val lastExecutionTime: Long? = null,
    ...
    override fun toString(): String {
        ...
        nodes.forEach { node ->
            when (node) {
                is com.kymjs.ai.custard.data.model.TriggerNode -> {
                ...
                is com.kymjs.ai.custard.data.model.ExecuteNode -> {
                ...
                is com.kymjs.ai.custard.data.model.ConditionNode -> {
                ...
                is com.kymjs.ai.custard.data.model.LogicNode -> {
                ...
                is com.kymjs.ai.custard.data.model.ExtractNode -> {
