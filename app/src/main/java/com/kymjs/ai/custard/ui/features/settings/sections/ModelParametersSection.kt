...
import com.kymjs.ai.custard.data.model.StandardModelParameters
...
fun ModelParametersSection(
        ...
        if (config.hasCustomParameters &&
            ...
            try {
                ...
                val customParamsList =
                    json.decodeFromString<List<com.kymjs.ai.custard.data.model.CustomParameterData>>(
                        config.customParameters
                    )
    ...
    // 状态
    var parameterToEdit by remember { mutableStateOf<com.kymjs.ai.custard.data.model.CustomParameterData?>(null) }
...
private fun convertCustomParameterDataToModelParameter(
    customParam: com.kymjs.ai.custard.data.model.CustomParameterData
): ModelParameter<*> {
...
): com.kymjs.ai.custard.data.model.CustomParameterData {
    return com.kymjs.ai.custard.data.model.CustomParameterData(
        id = param.id,
        name = param.name,
...
private fun AddCustomParameterDialog(
    onDismiss: () -> Unit,
    onSave: (com.kymjs.ai.custard.data.model.CustomParameterData) -> Unit,
    existingParam: com.kymjs.ai.custard.data.model.CustomParameterData? = null
) {
