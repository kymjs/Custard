...
import com.kymjs.ai.custard.util.GithubReleaseUtil
...
object PatchUpdateInstaller {
    ...
    const val ACTION_INSTALL_PATCH = "com.kymjs.ai.custard.action.INSTALL_PATCH_APK"
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (existing == null) {
                manager.createNotificationChannel(
                    NotificationChannel(
                        INSTALL_CHANNEL_ID,
                        context.getString(com.kymjs.ai.custard.R.string.patch_update),
    ...
    private fun notifyInstallReady(context: Context, apkFile: File, version: String) {
        try {
            ...
            val builder = NotificationCompat.Builder(context, INSTALL_CHANNEL_ID)
                ...
                .setContentTitle(context.getString(com.kymjs.ai.custard.R.string.patch_install_confirm_title))
