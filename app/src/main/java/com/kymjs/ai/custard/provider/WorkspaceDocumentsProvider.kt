package com.kymjs.ai.custard.provider
 ...
 * 路径: /data/data/com.kymjs.ai.custard/files/workspace
 */
class WorkspaceDocumentsProvider : DocumentsProvider() {
    ...
    companion object {
        ...
        private const val AUTHORITY = "com.kymjs.ai.custard.documents.workspace"
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        row.add(DocumentsContract.Root.COLUMN_TITLE, "Custard Workspace")
