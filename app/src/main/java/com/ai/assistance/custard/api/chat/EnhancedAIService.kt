...
import com.ai.assistance.custard.api.chat.enhance.ConversationMarkupManager
import com.ai.assistance.custard.api.chat.enhance.ConversationRoundManager
import com.ai.assistance.custard.api.chat.enhance.ConversationService
import com.ai.assistance.custard.api.chat.enhance.FileBindingService
import com.ai.assistance.custard.api.chat.enhance.InputProcessor
import com.ai.assistance.custard.api.chat.enhance.MultiServiceManager
import com.ai.assistance.custard.api.chat.enhance.ToolExecutionManager
...
class EnhancedAIService private constructor(private val context: Context) {
     ...
     * @param newState 新的状态
     */
    fun setInputProcessingState(newState: com.ai.assistance.custard.data.model.InputProcessingState) {
    ...
    init {
        com.ai.assistance.custard.api.chat.library.ProblemLibrary.initialize(context)
        initScope.launch {
            runCatching {
                ensureInitialized()
            }.onFailure { e ->
    ...
    private suspend fun handleTaskCompletion(context: MessageExecutionContext, content: String, enableMemoryQuery: Boolean, isSubTask: Boolean, characterName: String? = null, avatarUri: String? = null) {
        ...
        if (enableMemoryQuery) {
            ...
            toolProcessingScope.launch {
                com.ai.assistance.custard.api.chat.library.ProblemLibrary.saveProblemAsync(
                        this@EnhancedAIService.context,
                        toolHandler,
