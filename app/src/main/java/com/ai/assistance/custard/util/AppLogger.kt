...
/**
 * App-wide logger with an API closely mirroring [com.ai.assistance.custard.util.AppLogger].
 *
...
object AppLogger {
    ...
    // Mirror com.ai.assistance.custard.util.AppLogger priority constants
    ...
    private fun resolveLogFile(): File? {
        ...
        return try {
            val appContext: Context = try {
                CustardApplication.instance.applicationContext
            } catch (_: Throwable) {
    ...
    // --- Public API mirroring com.ai.assistance.custard.util.AppLogger ---
    ...
    fun resetLogFile() {
        try {
            val appContext: Context = CustardApplication.instance.applicationContext
            val dir = File(appContext.filesDir, LOG_DIR_NAME)
