package com.ai.assistance.custard.integrations.intent

import android.content.BroadcastReceiver
import android.content.Context
import android.content.Intent
import com.ai.assistance.custard.core.tools.defaultTool.standard.StandardChatManagerTool
...
class ExternalChatReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_EXTERNAL_CHAT = "com.ai.assistance.custard.EXTERNAL_CHAT"
        const val ACTION_EXTERNAL_CHAT_RESULT = "com.ai.assistance.custard.EXTERNAL_CHAT_RESULT"
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                if (!createNewChat && chatId.isNullOrBlank() && !createIfNone) {
                    ...
                    val current = (listResult.result as? com.ai.assistance.custard.core.tools.ChatListResultData)?.currentChatId
