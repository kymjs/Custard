    ...
    suspend fun generateWorkspaceAttachment(
        ...
        try {
            ...
            if (!workspaceEnv.isNullOrBlank()) {
                ...
                val existsData = existsRes.result as? com.ai.assistance.custard.core.tools.FileExistsData
...
<user_changes>
    ...
    private suspend fun loadGitIgnoreRules(
        ...
        val content = (res.result as? com.ai.assistance.custard.core.tools.FileContentData)?.content
    ...
    private suspend fun listRootEntries(
        ...
        workspacePath: String,
        workspaceEnv: String
    ): List<com.ai.assistance.custard.core.tools.DirectoryListingData.FileEntry> {
        val listRes =
            toolHandler.executeTool(
                AITool(
                    name = "list_files",
