...
import com.ai.assistance.custard.api.chat.llmprovider.RateLimitedAIService
import com.ai.assistance.custard.api.chat.llmprovider.RateLimiterRegistry
import com.ai.assistance.custard.api.chat.llmprovider.RequestConcurrencyRegistry
...
class MultiServiceManager(private val context: Context) {
    ...
    ): List<com.ai.assistance.custard.data.model.ModelParameter<*>> {
        ensureInitialized()
        val configMapping = functionalConfigManager.getConfigMappingForFunction(functionType)
