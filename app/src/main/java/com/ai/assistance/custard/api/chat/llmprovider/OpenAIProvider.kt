...
import com.ai.assistance.custard.api.chat.llmprovider.EndpointCompleter
...
import com.ai.assistance.custard.util.StreamingJsonXmlConverter
import com.ai.assistance.custard.util.TokenCacheManager
import com.ai.assistance.custard.util.exceptions.UserCancellationException
...
import com.ai.assistance.custard.api.chat.llmprovider.MediaLinkParser
...
open class OpenAIProvider(
        ...
        for (param in modelParameters) {
            if (param.isEnabled) {
                ...
                when (param.valueType) {
                    com.ai.assistance.custard.data.model.ParameterValueType.INT ->
                        jsonObject.put(mappedApiName, param.currentValue as Int)

                    com.ai.assistance.custard.data.model.ParameterValueType.FLOAT ->
                        jsonObject.put(mappedApiName, param.currentValue as Float)

                    com.ai.assistance.custard.data.model.ParameterValueType.STRING ->
                        jsonObject.put(mappedApiName, param.currentValue as String)

                    com.ai.assistance.custard.data.model.ParameterValueType.BOOLEAN ->
                        jsonObject.put(mappedApiName, param.currentValue as Boolean)

                    com.ai.assistance.custard.data.model.ParameterValueType.OBJECT -> {
     ...
     * 从结构化参数构建JSON Schema
     */
    private fun buildSchemaFromStructured(params: List<com.ai.assistance.custard.data.model.ToolParameterSchema>): JSONObject {
