...
class ApiPreferences private constructor(private val context: Context) {
    ...
    companion object {
        ...
        private fun decodeApiKey(encodedKey: String): String {
            return try {
                ...
                com.ai.assistance.custard.util.AppLogger.e("ApiPreferences", "Failed to decode API key", e)
                ""
            }
        }
    }
     ...
     */
    suspend fun getBillingModeForProviderModel(providerModel: String): com.ai.assistance.custard.data.model.BillingMode {
        val preferences = context.apiDataStore.data.first()
        val modeString = preferences[getBillingModeKey(providerModel)]
        return com.ai.assistance.custard.data.model.BillingMode.fromString(modeString)
    }
     ...
     * @param mode 计费方式
     */
    suspend fun setBillingModeForProviderModel(providerModel: String, mode: com.ai.assistance.custard.data.model.BillingMode) {
        context.apiDataStore.edit { preferences ->
