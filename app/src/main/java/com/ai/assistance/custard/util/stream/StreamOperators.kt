package com.ai.assistance.custard.util.stream

import com.ai.assistance.custard.util.AppLogger
import com.ai.assistance.custard.util.stream.plugins.PluginState
import com.ai.assistance.custard.util.stream.plugins.StreamPlugin
