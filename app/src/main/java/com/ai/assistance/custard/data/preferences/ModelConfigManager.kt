...
import com.ai.assistance.custard.data.model.CustomParameterData
...
class ModelConfigManager(private val context: Context) {
    ...
    suspend fun updateModelConfig(
            ...
            apiEndpoint: String,
            modelName: String,
            apiProviderType: com.ai.assistance.custard.data.model.ApiProviderType
    ): ModelConfigData {
        return updateConfigInternal(configId) {
            it.copy(
                    apiKey = apiKey,
...
private fun ModelParameter<*>.toCustomParameterData(): com.ai.assistance.custard.data.model.CustomParameterData {
