...
import com.ai.assistance.custard.provider.IAccessibilityProvider
...
object UIHierarchyManager {
    ...
    // 新的无障碍服务提供者应用的包名
    private const val PROVIDER_PACKAGE_NAME = "com.ai.assistance.custard.provider"
    // 无障碍服务提供者APK的文件名
    private const val PROVIDER_APK_NAME = "accessibility.apk"
    // 用于绑定的自定义Action，必须与服务提供者应用中的声明一致
    private const val PROVIDER_ACTION = "com.ai.assistance.custard.provider.IAccessibilityProvider"
