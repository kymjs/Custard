package com.ai.assistance.custard.api.chat.library
...
object ProblemLibrary {
    ...
    private fun buildPreferencesText(context: Context, profile: com.ai.assistance.custard.data.model.PreferenceProfile): String {
