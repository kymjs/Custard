package com.ai.assistance.custard.api.chat
...
import com.ai.assistance.custard.api.speech.PersonalWakeListener
import com.ai.assistance.custard.api.speech.SpeechPrerollStore
import com.ai.assistance.custard.api.speech.SpeechService
...
import com.ai.assistance.custard.core.application.ActivityLifecycleManager
...
import com.ai.assistance.custard.services.UIDebuggerService
...
import com.ai.assistance.custard.data.repository.WorkflowRepository
...
class AIForegroundService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_CANCEL_CURRENT_OPERATION = "com.ai.assistance.custard.action.CANCEL_CURRENT_OPERATION"
        private const val REQUEST_CODE_CANCEL_CURRENT_OPERATION = 9002

        private const val ACTION_EXIT_APP = "com.ai.assistance.custard.action.EXIT_APP"
        private const val REQUEST_CODE_EXIT_APP = 9003

        private const val ACTION_TOGGLE_WAKE_LISTENING = "com.ai.assistance.custard.action.TOGGLE_WAKE_LISTENING"
        private const val REQUEST_CODE_TOGGLE_WAKE_LISTENING = 9006

        private const val ACTION_SET_WAKE_LISTENING_SUSPENDED_FOR_IME =
            "com.ai.assistance.custard.action.SET_WAKE_LISTENING_SUSPENDED_FOR_IME"
        ...
        private const val ACTION_SET_WAKE_LISTENING_SUSPENDED_FOR_FLOATING_FULLSCREEN =
            "com.ai.assistance.custard.action.SET_WAKE_LISTENING_SUSPENDED_FOR_FLOATING_FULLSCREEN"
        private const val EXTRA_FLOATING_FULLSCREEN_ACTIVE = "extra_floating_fullscreen_active"

        const val ACTION_PREPARE_WAKE_HANDOFF =
            "com.ai.assistance.custard.action.PREPARE_WAKE_HANDOFF"

        private const val ACTION_ENSURE_MICROPHONE_FOREGROUND =
            "com.ai.assistance.custard.action.ENSURE_MICROPHONE_FOREGROUND"
    ...
    private fun triggerWakeLaunch() {
        ...
        try {
            val floatingIntent = Intent(this, FloatingChatService::class.java).apply {
                putExtra("INITIAL_MODE", com.ai.assistance.custard.ui.floating.FloatingMode.FULLSCREEN.name)
