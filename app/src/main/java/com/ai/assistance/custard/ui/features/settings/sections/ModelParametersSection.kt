...
import com.ai.assistance.custard.data.model.ParameterCategory
import com.ai.assistance.custard.data.model.ParameterValueType
import com.ai.assistance.custard.data.model.StandardModelParameters
...
fun ModelParametersSection(
        ...
        if (config.hasCustomParameters &&
            ...
            try {
                ...
                val customParamsList =
                    json.decodeFromString<List<com.ai.assistance.custard.data.model.CustomParameterData>>(
                        config.customParameters
                    )
    ...
    // 状态
    var parameterToEdit by remember { mutableStateOf<com.ai.assistance.custard.data.model.CustomParameterData?>(null) }
...
private fun convertCustomParameterDataToModelParameter(
    customParam: com.ai.assistance.custard.data.model.CustomParameterData
): ModelParameter<*> {
...
): com.ai.assistance.custard.data.model.CustomParameterData {
    return com.ai.assistance.custard.data.model.CustomParameterData(
        id = param.id,
        name = param.name,
...
private fun AddCustomParameterDialog(
    onDismiss: () -> Unit,
    onSave: (com.ai.assistance.custard.data.model.CustomParameterData) -> Unit,
    existingParam: com.ai.assistance.custard.data.model.CustomParameterData? = null
) {
