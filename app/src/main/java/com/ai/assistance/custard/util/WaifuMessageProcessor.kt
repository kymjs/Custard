...
import com.ai.assistance.custard.util.markdown.NestedMarkdownProcessor
import com.ai.assistance.custard.util.stream.splitBy as streamSplitBy
...
object WaifuMessageProcessor {
    ...
    fun splitMessageBySentences(content: String, removePunctuation: Boolean = false): List<String> {
        ...
        com.ai.assistance.custard.util.AppLogger.d("WaifuMessageProcessor", "分割出${finalResult.size}个结果")
    ...
    fun shouldSplitMessage(content: String): Boolean {
        ...
        // 添加调试日志
        com.ai.assistance.custard.util.AppLogger.d("WaifuMessageProcessor", 
    ...
    fun separateEmotionAndText(content: String): List<String> {
        ...
        com.ai.assistance.custard.util.AppLogger.d("WaifuMessageProcessor", "分离表情包和文本: ${result.size}个元素")
        return result
    }
    ...
    private fun getRandomEmojiPath(emotion: String): String? {
        try {
            ...
            val customEmoji = try {
                customEmojiRepository?.let { repo ->
                    runBlocking {
                        ...
                        if (emojis.isNotEmpty()) {
                            ...
                            if (file.exists()) {
                                com.ai.assistance.custard.util.AppLogger.d("WaifuMessageProcessor", "使用自定义表情: ${file.absolutePath}")
                ...
                com.ai.assistance.custard.util.AppLogger.e("WaifuMessageProcessor", "查询自定义表情失败", e)
                null
            }
            ...
            com.ai.assistance.custard.util.AppLogger.w("WaifuMessageProcessor", "在自定义表情中未找到对于情绪 '$emotion' 的表情")
            return null
            
        } catch (e: Exception) {
            com.ai.assistance.custard.util.AppLogger.e("WaifuMessageProcessor", "获取表情图片失败: $emotion", e)
            return null
        }
    }
} 