package com.ai.assistance.custard.util.vector
    ...
    fun initIndex() {
        index = if (indexFile != null && indexFile.exists()) {
            try {
                ...
                com.ai.assistance.custard.util.AppLogger.e("VectorIndexManager", "Failed to load index, creating new one.", e)
    ...
    fun save() {
        if (indexFile != null && index != null) {
            try {
                ...
                com.ai.assistance.custard.util.AppLogger.e("VectorIndexManager", "Failed to save index to ${indexFile.absolutePath}", e)
            }
        }
    }
