...
data class WorkflowDetailResultData(
    ...
    val name: String,
    val description: String,
    val nodes: List<com.ai.assistance.custard.data.model.WorkflowNode>,
    val connections: List<com.ai.assistance.custard.data.model.WorkflowNodeConnection>,
    val enabled: Boolean,
    val createdAt: Long,
    val updatedAt: Long,
    val lastExecutionTime: Long? = null,
    ...
    override fun toString(): String {
        ...
        nodes.forEach { node ->
            when (node) {
                is com.ai.assistance.custard.data.model.TriggerNode -> {
                ...
                is com.ai.assistance.custard.data.model.ExecuteNode -> {
                ...
                is com.ai.assistance.custard.data.model.ConditionNode -> {
                ...
                is com.ai.assistance.custard.data.model.LogicNode -> {
                ...
                is com.ai.assistance.custard.data.model.ExtractNode -> {
