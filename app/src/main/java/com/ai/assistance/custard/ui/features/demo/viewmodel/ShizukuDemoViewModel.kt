package com.ai.assistance.custard.ui.features.demo.viewmodel
...
import com.ai.assistance.custard.ui.features.demo.state.DemoStateManager
...
class ShizukuDemoViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val uiState: StateFlow<com.ai.assistance.custard.ui.features.demo.state.DemoScreenState> =
