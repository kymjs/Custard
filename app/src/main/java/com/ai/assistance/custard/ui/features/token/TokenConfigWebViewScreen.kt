package com.ai.assistance.custard.ui.features.token
...
import com.ai.assistance.custard.ui.features.token.components.UrlConfigDialog
import com.ai.assistance.custard.ui.features.token.model.NavDestination
import com.ai.assistance.custard.ui.features.token.model.getIconForIndex
import com.ai.assistance.custard.ui.features.token.preferences.UrlConfigManager
import com.ai.assistance.custard.ui.features.token.webview.WebViewConfig
...
fun TokenConfigWebViewScreen(onNavigateBack: () -> Unit) {
    ...
    // 获取URL配置
    val urlConfig by urlConfigManager.urlConfigFlow.collectAsState(initial = com.ai.assistance.custard.ui.features.token.model.UrlConfig())
