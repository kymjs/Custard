/* METADATA
{
  ...
  "description": {
    "zh": "使用智谱AI图像生成API根据提示词画图，将图片保存到本地 /sdcard/Download/Custard/draws/ 目录，并返回 Markdown 图片提示。",
    "en": "Generate images via Zhipu AI image generation API from a prompt, save to /sdcard/Download/Custard/draws/, and return a Markdown image reference."
  },
  "env": [
    {
      "name": "ZHIPU_API_KEY",
