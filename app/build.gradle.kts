...
android {
    ...
    defaultConfig {
        ...
        val githubClientId = (localProperties.getProperty("GITHUB_CLIENT_ID") ?: "").trim().removeSurrounding("\"")
        val githubClientSecret = (localProperties.getProperty("GITHUB_CLIENT_SECRET") ?: "").trim().removeSurrounding("\"")
...
dependencies {
    ...
    // Room 数据库（使用 KSP 避免 KAPT 下 processingEnv 为 null 的 NPE）
