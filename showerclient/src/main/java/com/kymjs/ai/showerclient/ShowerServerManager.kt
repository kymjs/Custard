package com.kymjs.ai.showerclient
...
object ShowerServerManager {
    ...
    suspend fun ensureServerStarted(context: Context): Boolean {
        ...
        val killCmd = "pkill -f com.kymjs.ai.shower.Main || true"
        ...
        val startCmd = "CLASSPATH=$remoteJarPath app_process / com.kymjs.ai.shower.Main $targetPackagesArg &"
    ...
    suspend fun stopServer(): Boolean {
        ...
        val cmd = "pkill -f com.kymjs.ai.shower.Main || true"
