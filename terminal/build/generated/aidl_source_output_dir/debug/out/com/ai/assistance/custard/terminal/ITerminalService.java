...
public interface ITerminalService extends android.os.IInterface
{
  ...
  public static class Default implements com.ai.assistance.custard.terminal.ITerminalService
  {
    ...
    @Override public void registerCallback(com.ai.assistance.custard.terminal.ITerminalCallback callback) throws android.os.RemoteException
    {
    }
    @Override public void unregisterCallback(com.ai.assistance.custard.terminal.ITerminalCallback callback) throws android.os.RemoteException
    {
    }
  ...
  public static abstract class Stub extends android.os.Binder implements com.ai.assistance.custard.terminal.ITerminalService
  {
    ...
    /**
     * Cast an IBinder object into an com.ai.assistance.custard.terminal.ITerminalService interface,
     * generating a proxy if needed.
     */
    public static com.ai.assistance.custard.terminal.ITerminalService asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof com.ai.assistance.custard.terminal.ITerminalService))) {
        return ((com.ai.assistance.custard.terminal.ITerminalService)iin);
      }
      return new com.ai.assistance.custard.terminal.ITerminalService.Stub.Proxy(obj);
    }
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        {
          com.ai.assistance.custard.terminal.ITerminalCallback _arg0;
          _arg0 = com.ai.assistance.custard.terminal.ITerminalCallback.Stub.asInterface(data.readStrongBinder());
    ...
    private static class Proxy implements com.ai.assistance.custard.terminal.ITerminalService
    {
  ...
  /** @hide */
  public static final java.lang.String DESCRIPTOR = "com.ai.assistance.custard.terminal.ITerminalService";
  ...
  public void registerCallback(com.ai.assistance.custard.terminal.ITerminalCallback callback) throws android.os.RemoteException;
  public void unregisterCallback(com.ai.assistance.custard.terminal.ITerminalCallback callback) throws android.os.RemoteException;
