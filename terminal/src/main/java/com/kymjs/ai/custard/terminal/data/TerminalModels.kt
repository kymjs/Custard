package com.kymjs.ai.custard.terminal.data
...
data class TerminalSessionData(
    ...
    val terminalSession: com.kymjs.ai.custard.terminal.TerminalSession? = null,
    val pty: com.kymjs.ai.custard.terminal.Pty? = null, // PTY 对象，用于获取终端模式
