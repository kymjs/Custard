...
import com.kymjs.ai.custard.terminal.data.TerminalState
import com.kymjs.ai.custard.terminal.data.CommandHistoryItem
import com.kymjs.ai.custard.terminal.data.QueuedCommand
import com.kymjs.ai.custard.terminal.view.domain.OutputProcessor
...
import com.kymjs.ai.custard.terminal.data.SessionInitState
import com.kymjs.ai.custard.terminal.utils.SourceManager
import com.kymjs.ai.custard.terminal.utils.SSHConfigManager
import com.kymjs.ai.custard.terminal.utils.SSHDServerManager
...
import com.kymjs.ai.custard.terminal.provider.type.TerminalProvider
import com.kymjs.ai.custard.terminal.provider.type.TerminalType
import com.kymjs.ai.custard.terminal.provider.type.LocalTerminalProvider
import com.kymjs.ai.custard.terminal.provider.type.SSHTerminalProvider
...
class TerminalManager private constructor(
    ...
    suspend fun createNewSession(
        ...
        val success = withTimeoutOrNull(30000) { // 30秒超时
            terminalState.first { state ->
                ...
                session?.initState == com.kymjs.ai.custard.terminal.data.SessionInitState.READY
            }
        }
    ...
    private fun handleRegularCommand(command: String, session: com.kymjs.ai.custard.terminal.data.TerminalSessionData, commandId: String) {
