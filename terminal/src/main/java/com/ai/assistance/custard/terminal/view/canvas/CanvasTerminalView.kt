package com.ai.assistance.custard.terminal.view.canvas
...
import android.view.accessibility.AccessibilityManager
 ...
 import com.ai.assistance.custard.terminal.R
 import com.ai.assistance.custard.terminal.view.domain.ansi.AnsiTerminalEmulator
 import com.ai.assistance.custard.terminal.view.domain.ansi.TerminalChar
 import java.io.File
...
class CanvasTerminalView @JvmOverloads constructor(
    ...
    // PTY 引用（用于窗口大小同步）
    private var pty: com.ai.assistance.custard.terminal.Pty? = null
     ...
     * 设置 PTY（用于窗口大小同步）
     */
    fun setPty(pty: com.ai.assistance.custard.terminal.Pty?) {
        this.pty = pty
