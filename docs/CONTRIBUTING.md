...
欢迎加入 Custard 开源生态！我们欢迎不同类型的贡献者。

## 脚本与插件开发者

### 📜 脚本开发

Custard 支持通过 TypeScript/JavaScript 脚本来扩展 AI 的能力。完整指南请参考 [脚本开发指南 (SCRIPT_DEV_GUIDE.md)](./SCRIPT_DEV_GUIDE.md)。

### 🔌 MCP 插件开发

你可以开发自己的 MCP 插件来扩展 AI 的能力，如网页浏览、图像处理等。在 Custard AI 中导入你的插件仓库或 zip 文件即可开始。

## Custard 本体开发者

参与 Custard AI 本体开发，请遵循以下精简指南。
...
1.  **先沟通**: 在 [Issue 区](https://github.com/kymjs/Custard/issues) 提出你的想法或认领任务，**避免重复造轮子**。
...
1.  **准备工作**:
    - Fork 本仓库并 Clone 到本地。
    - 添加上游仓库: `git remote add upstream https://github.com/kymjs/Custard.git`
...
我们期待您的贡献！你的每一次 PR、Issue 和讨论都在帮助 Custard 成长。
...
我们非常欢迎并鼓励社区基于 Custard AI 进行二次创作和改进。为了维护项目的透明度和社区的健康发展，我们强烈建议所有衍生项目：
