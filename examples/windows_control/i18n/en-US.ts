...
export const WINDOWS_SETUP_EN_US: WindowsSetupI18n = {
  ...
  step1Desc: "Export and share Custard PC Agent ZIP to the target Windows device.",
  step1Button: "Export and Share ZIP",
  exporting: "Exporting...",
  shareTitle: "Custard PC Agent",
  ...
  step2Desc:
    "On Windows, unzip the exported ZIP. In the extracted file list, find custard_pc_agent.bat and double-click it.",
