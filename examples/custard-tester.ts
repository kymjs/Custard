 ...
 * 
 * How to run:
 * 1. Compile: tsc custard-tester.ts
 * 2. Run via command line:
 *    - Windows: .\tools\execute_js.bat custard-tester.js main '{}'
 *    - Linux/macOS: ./tools/execute_js.sh custard-tester.js main '{}'
 *    - Specific test category: .\tools\execute_js.bat custard-tester.js testCategory '{"testType":"ui"}'
 */
...
async function testMakeDirectory(results: TestResults): Promise<void> {
    try {
        ...
        const testDirPath = "/sdcard/custard_test_directory";
...
async function testCopyFile(results: TestResults): Promise<void> {
    try {
        ...
        const sourcePath = "/sdcard/custard_test_file.txt";
        const destPath = "/sdcard/custard_test_directory/copied_file.txt";
...
async function testMoveFile(results: TestResults): Promise<void> {
    try {
        ...
        const sourcePath = "/sdcard/custard_test_directory/copied_file.txt";
        const destPath = "/sdcard/custard_test_directory/moved_file.txt";
...
async function testZipFiles(results: TestResults): Promise<void> {
    try {
        ...
        const sourceDir = "/sdcard/custard_test_directory";
        const destZip = "/sdcard/custard_test.zip";
...
async function testUnzipFiles(results: TestResults): Promise<void> {
    try {
        ...
        const sourceZip = "/sdcard/custard_test.zip";
        const destDir = "/sdcard/custard_test_extracted";
...
async function testDeleteFile(results: TestResults): Promise<void> {
    try {
        ...
        const testPaths = [
            "/sdcard/custard_test_file.txt",
            "/sdcard/custard_test_directory",
            "/sdcard/custard_test.zip",
            "/sdcard/custard_test_extracted"
        ];
...
async function testDownloadFile(results: TestResults): Promise<void> {
    try {
        ...
        const downloadPath = "/sdcard/custard_test_download.png";
