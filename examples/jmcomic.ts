    ...
    "tools": [
        ...
        },
        {
            ...
            "parameters": [
                ...
                {
                    "name": "download_dir",
                    "description": { "zh": "下载目录 (可选, 默认: /sdcard/Download/CustardScripts)", "en": "Download directory (optional; default: /sdcard/Download/CustardScripts)." },
                    "type": "string",
                    "required": false
                }
            ]
...
const jmcomic = (function () {
    ...
    class JmOptionImpl {
        ...
        constructor(baseDir: string = "/sdcard/Download/CustardScripts") {
            this.dirRule = new DirRuleImpl(baseDir);
        }

        static default(baseDir: string = "/sdcard/Download/CustardScripts"): JmOptionImpl {
    ...
    class SimpleJMDownloader {
        ...
        constructor(downloadDir: string = "/sdcard/Download/CustardScripts") {
    ...
    async function main() {
        ...
        const downloader = new SimpleJMDownloader("/sdcard/Download/CustardScripts/test_downloads");
        const testQuery = "原神";
