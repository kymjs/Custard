...
const jmcomic = (function () {
    ...
    class JmOptionImpl {
        constructor(baseDir = "/sdcard/Download/CustardScripts") {
            this.dirRule = new DirRuleImpl(baseDir);
        }
        static default(baseDir = "/sdcard/Download/CustardScripts") {
    ...
    class SimpleJMDownloader {
        constructor(downloadDir = "/sdcard/Download/CustardScripts") {
