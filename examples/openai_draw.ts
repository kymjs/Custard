/* METADATA
{
  ...
  "description": {
    "zh": "使用 OpenAI 格式的图像生成 API (/v1/images/generations) 根据提示词画图，将图片保存到本地 /sdcard/Download/Custard/draws/ 目录，并返回 Markdown 图片提示。",
    "en": "Generate images via an OpenAI-compatible image generation API (/v1/images/generations) from a prompt, save to /sdcard/Download/Custard/draws/, and return a Markdown image reference."
  },
  "env": [
    {
      "name": "OPENAI_API_KEY",
